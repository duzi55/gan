 ...
 *     （4.5px / viewBox 100）、白填充、豆豆眼、圆头圆脑，只露头；
  ...
  return (
    <svg viewBox="0 0 100 100" className={className} aria-hidden="true">
      ...
      <g {...COMMON}>
        ...
        <path d="M24 60 h-13 M25 66 l-12 5 M76 60 h13 M75 66 l12 5" fill="none" strokeWidth="3.2" />
      </g>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 100 100" className={className} aria-hidden="true">
      ...
      <g {...COMMON}>
        ...
        <path d="M50 70 v4 M50 74 q-4 4 -8 2 M50 74 q4 4 8 2" fill="none" strokeWidth="3.4" />
      </g>
    </svg>
  );
}
...
export function AlligatorIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 100 100" className={className} aria-hidden="true">
      ...
      <g {...COMMON} fill="none" strokeWidth="3.6">
...
export function RobotIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 100 100" className={className} aria-hidden="true">
      ...
      <path d="M41 64 h18" fill="none" stroke={STROKE} strokeWidth="3.6" strokeLinecap="round" />
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 120 104" className={className} aria-hidden="true">
      <g {...COMMON}>
        ...
        {/* 滑板 */}
        <path d="M12 84 q48 9 96 0" fill="none" strokeWidth="5.5" />
      </g>
      {/* 鼻 + 眼 */}
      <g fill={STROKE} stroke="none">
