...
const galleryPreviews = [
  { title: "Liquid", gradient: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)" },
  { title: "Sunset", gradient: "linear-gradient(135deg, #f093fb 0%, #f5576c 100%)" },
  { title: "Midnight", gradient: "linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)" },
  { title: "Pastel", gradient: "linear-gradient(135deg, #a8edea 0%, #fed6e3 100%)" },
  { title: "Ember", gradient: "linear-gradient(135deg, #ff9a56 0%, #ff6a88 100%)" },
  { title: "Ocean", gradient: "linear-gradient(135deg, #2c3e50 0%, #4ca1af 100%)" },
];
    ...
    <div className="min-h-screen bg-[#fbfaf7]">
      ...
      <section className="relative">
        <div className="mx-auto max-w-5xl px-6 pt-4 pb-2 text-center">
          <h2 className="mb-1 text-xs font-semibold uppercase tracking-[0.25em] text-zinc-400">
            Portfolio Showcase
          </h2>
        </div>
        <PortfolioCarousel3D />
      ...
      <section className="mx-auto max-w-5xl px-6 py-20">
        <div className="mb-12 flex items-end justify-between">
          <div>
            <h2 className="font-serif text-2xl font-bold tracking-wide text-zinc-900 md:text-3xl">
              文章
            </h2>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="space-y-5 lg:col-span-2">
            {posts.map((post, idx) => (
              ...
              >
                <article
                  className="relative flex overflow-hidden rounded-2xl border border-zinc-200/60 bg-white/60 shadow-sm transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] hover:shadow-lg hover:shadow-zinc-200/60"
                >
                  {/* Gradient strip */}
                  <div
                  ...
                  >
                    <span className="absolute bottom-3 left-3 right-3 font-serif text-[3rem] font-bold leading-none text-white/15">
                  ...
                  <div className="flex flex-1 flex-col justify-center px-6 py-5">
                    ...
                    <h3 className="mb-2 font-serif text-lg font-bold leading-snug text-zinc-900 transition-colors group-hover:text-zinc-600 md:text-xl">
                      {post.title}
                    </h3>
                  ...
                  <div className="flex items-center pr-6">
                    <span className="text-2xl text-zinc-300 transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] group-hover:translate-x-1 group-hover:text-zinc-500">
                      →
                    </span>
                  </div>
                </article>
          ...
          {/* Sidebar — UI Components in action */}
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
            {galleryPreviews.map((g) => (
              ...
              >
                <div
                  className="absolute inset-0 transition-transform duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] group-hover:scale-110"
      ...
      <section className="border-t border-zinc-200/60 py-16">
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <Link
            href="/gallery"
            className="mt-6 inline-block font-serif text-sm tracking-wide text-zinc-500 underline decoration-zinc-300 underline-offset-4 transition-colors hover:text-zinc-900"
          >
            探索图片流 →
          </Link>
        </div>
